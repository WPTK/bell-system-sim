...
""")
    ...
    def handle_command(self, cmd):
        ...
        if base_cmd == "cd":
            ...
            print("Longitudinal balance: 60dB")
            print("Background noise: -82dBm")
            print("Return loss: 26dB @ 1004Hz")
            print("Impulse noise: <10 counts/15min")
            print("Phase jitter: 0.5 degrees")
            print("\nAvailable Tests:")
            print("- test loop   : Loop resistance test")
            print("- test tone   : 1004Hz reference tone")
            print("- test noise  : C-notched noise")
            print("- test sweep  : Frequency response")
            print("- test balance: Longitudinal balance")
        elif cmd.startswith("test"):
            parts = cmd.split()
            if len(parts) > 1:
                if parts[1] == "loop":
                    print("Running loop resistance test...")
                    print("Tip-Ring: 912Ω")
                    print("Tip-Ground: >100kΩ")
                    print("Ring-Ground: >100kΩ")
                    print("Foreign EMF: <0.5V")
                elif parts[1] == "tone":
                    print("Sending 1004Hz test tone...")
                    print("Level: 0.0dBm")
                    print("Duration: 30 seconds")
                    print("Impedance: 600Ω")
                elif parts[1] == "noise":
                    print("C-notched noise measurement...")
                    print("Metallic noise: 20dBrnc")
                    print("Single frequency interference: None")
                    print("Power influence: 80dB")
                elif parts[1] == "sweep":
                    print("Frequency response sweep 404-2804Hz...")
                    print("404Hz: -0.2dB")
                    print("1004Hz: 0.0dB (reference)")
                    print("2804Hz: -0.5dB")
                    print("Envelope delay distortion: 180μs")
                elif parts[1] == "balance":
                    print("Longitudinal balance test...")
                    print("Frequency: 1004Hz")
                    print("Balance ratio: 60dB")
                    print("Metallic termination: 600Ω + 2.16μF")
        elif cmd == "crossbar":
